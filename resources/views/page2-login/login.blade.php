...
<head>
    ...
    <title>Millennium School : Login</title>
                    ...
                    <div class="card-3d-wrap mx-auto">
                        <div class="card-3d-wrapper">
                            <div class="card-front">
                                <form method="post" action="/login-auth" id="sensei">
                                    @csrf
                                    <div class="center-wrap">
                                        <div class="section text-center">
                                            <h4 class="mb-4 pb-3">Login Sensei</h4>
                                            <div class="form-group">
                                                <input type="text" name="nama" class="form-control" placeholder="Masukkan username" id="nama" autocomplete="off">
                            ...
                            <div class="card-back" >
                                <form method="post" action="/login-auth" id="sekretaris">
                                    @csrf
                                    <div class="center-wrap">
                                        <div class="section text-center">
                                            <h4 class="mb-4 pb-3">Login Sekretaris</h4>
                                            <div class="form-group">
                                                <input type="text" name="nama" class="form-control" placeholder="Masukkan username" id="logname" autocomplete="off">
